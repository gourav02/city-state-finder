...
const cities = [{city:'Kolhapur', state:'Maharashtra'},
...
srch.addEventListener("change" , display);
srch.addEventListener("keyup" ,display);
...
const html=find.map(place=>{
  ...
  `;
}).join('');//this return an array.so to make it a string.
